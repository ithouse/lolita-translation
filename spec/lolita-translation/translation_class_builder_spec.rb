...
describe Lolita::Translation::TranslationClassBuilder do 
  ...
  context "ActiveRecord" do 
    ...
    it "should build concrete class when #build is called" do 
      obj = klass.new(Class.new(ActiveRecord::Base))
      obj.builder.should_receive(:build_klass).and_return(true)
      obj.builder.should_receive(:call_klass_class_methods).and_return(true)
      obj.builder.should_receive(:update_base_klass).and_return(true)
      obj.build_class
    end
  end
